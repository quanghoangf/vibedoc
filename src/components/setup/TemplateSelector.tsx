...
import { Bot, FileText, Building2, Server, BookOpen, AlertTriangle, Calendar, Users, Check } from "lucide-react"
...
const TEMPLATES = [
  {
    ...
    items: [
      { id: "claude-md", name: "CLAUDE.md", description: "AI agent instructions", icon: Bot, path: "CLAUDE.md" },
